...
def generate_commit_message(prompt):
    """Sends the prompt directly to the Gemini REST API."""
    print("✨ Asking Gemini to generate the commit message...")
    strict_prompt = (
        # "As an expert programmer, write a conventional git commit message.\n"
        # "Base it STRICTLY ONLY on the following instructions and git context.\n"
        "--- GIT CONTEXT ---\n"
        f"{prompt}"
        "The output MUST be only the raw commit message text, without any explanatory sentences or markdown code blocks like ```.\n"
        # "Kindly add a single line at the end of the commit body: 'Generated by Google Gemini 2.0 Flash.'\n\n"
    )
    ...
    try:
        ...
        if 'candidates' in json_response and json_response['candidates']:
            # raw_text = json_response['candidates']['content']['parts']['text'] #Wrong logic
